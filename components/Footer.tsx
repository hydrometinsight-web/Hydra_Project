        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center space-x-3 pt-1">
              <a 
                href="https://x.com/hydrometinsight"
                target="_blank"
              ...
              <a 
                href="https://www.instagram.com/hydrometinsight/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 flex items-center justify-center text-gray-400 hover:text-[#93D419] transition-colors duration-200"
              ...
              <a 
                href="https://www.linkedin.com/company/hydrometinsight"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 flex items-center justify-center text-gray-400 hover:text-[#93D419] transition-colors duration-200"
                aria-label="LinkedIn"
              ...
              <a 
                href="https://www.youtube.com/@hydrometinsight"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 flex items-center justify-center text-gray-400 hover:text-[#93D419] transition-colors duration-200"
                aria-label="YouTube"
